// Perlin noise - colors switch in time bands
...
function draw() {
  ...
  for (let i = 0; i < 1000; i++) {
    ...
    const n = smoothNoise(x + offset * 50, y, 50) * 0.5 +
              smoothNoise(x + offset * 50, y, 25) * 0.25 +
              smoothNoise(x + offset * 50, y, 12) * 0.125;
