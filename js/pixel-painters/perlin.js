...
function draw() {
  ...
  for (let i = 0; i < 1000; i++) {
    ...
    // Multi-octave noise (3 octaves for detail)
    const n = smoothNoise(x + offset * 50, y, 50) * 0.5 +      // Large features
              smoothNoise(x + offset * 50, y, 25) * 0.25 +     // Medium details
              smoothNoise(x + offset * 50, y, 12) * 0.125;     // Fine texture
